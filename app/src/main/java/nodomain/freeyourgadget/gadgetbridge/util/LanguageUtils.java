    ...
    private static Map<Character, String> transliterateMap = new HashMap<Character, String>(){
        {
            ...
            // greek chars
            put('ά',"α");put('έ',"ε");put('ή',"η");put('ί',"ι");put('ϊ',"ι");put('ΐ',"ι");put('ό',"ο");put('ς',"s");put('ύ',"υ");put('ϋ',"υ");put('ΰ',"υ");put('ώ',"ω");
            put('Ά',"A");put('Έ',"E");put('Ή',"Η");put('Ί',"I");put('Ϊ',"I");put('Ό',"O");put('Ύ',"Y");put('Ϋ',"Y");put('Ώ',"Ω");

            //ALL CAPITALS
           /*
            put('α',"Α");put('ά',"Α");put('β',"Β");put('γ',"Γ");put('δ',"Δ");put('ε',"Ε");put('έ',"Ε");put('ζ',"Ζ");put('η',"Η");
            put('ή',"Η");put('θ',"Θ");put('ι',"Ι");put('ί',"Ι");put('ϊ',"Ι");put('ΐ',"Ι");put('κ',"Κ");put('λ',"Λ");put('μ',"Μ");
            put('ν',"Ν");put('ξ',"Ξ");put('ο',"Ο");put('ό',"Ο");put('π',"Π");put('ρ',"Ρ");put('σ',"Σ");put('ς',"Σ");put('τ',"Τ");
            put('υ',"Υ");put('ύ',"Υ");put('ϋ',"Υ");put('ΰ',"Υ");put('φ',"Φ");put('χ',"Χ");put('ψ',"Ψ");put('ω',"Ω");put('ώ',"Ω");
            put('Α',"A");put('Ά',"A");put('Β',"B");put('Γ',"Γ");put('Δ',"Δ");put('Ε',"E");put('Έ',"E");put('Ζ',"Z");put('Η',"Η");
            put('Ή',"Η");put('Θ',"Θ");put('Ι',"I");put('Ί',"I");put('Ϊ',"I");put('Κ',"K");put('Λ',"Λ");put('Μ',"M");put('Ν',"N");
            put('Ξ',"Ξ");put('Ο',"O");put('Ό',"O");put('Π',"Π");put('Ρ',"Ρ");put('Σ',"Σ");put('Τ',"T");put('Υ',"Y");put('Ύ',"Y");
            put('Ϋ',"Y");put('Φ',"Φ");put('Χ',"Χ");put('Ψ',"Ψ");put('Ω',"Ω");put('Ώ',"Ω");
            */
